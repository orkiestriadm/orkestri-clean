...
export const HISTORICO: { versao: string; data: string; titulo: string; itens: string[] }[] = [
  {
    versao: "1.46.1",
    data: "2026-09-18",
    titulo: "Relatório de feedback inclui o dia de hoje",
    itens: [
      "O filtro \"até\" dos relatórios de feedback cortava o próprio dia: o que foi registrado hoje não saía no relatório de hoje",
    ],
  },
  {
    versao: "1.46.0",
  ...
  },
  {
    versao: "1.44.6",
    data: "2026-09-18",
    titulo: "Menu Feedback no People",
    itens: [
      "O item do menu People passa a se chamar Feedback (antes: Avaliação de Desempenho)",
    ],
  },
  {
    versao: "1.44.5",
    data: "2026-09-18",
    titulo: "Avaliação de Desempenho logo abaixo de Colaboradores",
    itens: [
      "No menu People, Avaliação de Desempenho passa a ficar logo depois de Colaboradores, em vez de no fim do grupo",
    ],
  },
  {
    versao: "1.44.4",
  ...
  },
  {
    versao: "1.43.4",
    data: "2026-09-17",
    titulo: "Correção: o RH via a lista de feedbacks vazia",
    itens: [
      "Quem tem acesso à organização inteira (RH e administrador) voltou a ver os feedbacks na lista — inclusive os pedidos de exclusão que estavam esperando decisão",
    ],
  },
  {
    versao: "1.43.3",
