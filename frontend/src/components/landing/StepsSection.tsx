...
const STEPS = [
  {
    ...
    desc: 'Controle sua operação, agendamentos, projetos, fornecedores e financeiro em um único ambiente integrado e auditável. Elimine planilhas e sistemas fragmentados de uma vez.',
    tag: 'Setup em < 24h',
  },
  {
    number: '02',
