          ...
          {PLANS.map((plan, i) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`group/card relative flex flex-col h-full w-full transition-all duration-300 ease-out ${
                    isHighlight
                ...
                >
                  ...
                  <div
                    className={`relative z-10 rounded-3xl border flex flex-col h-full w-full transition-all duration-300 ease-out ${
                      isHighlight
                    ...
                    <div className="p-8 pb-0">
                      <div className="pt-2">
                        <h3 className={`font-display font-bold text-2xl mb-2 transition-colors ${
                          isHighlight ? 'text-white' : 'text-[var(--text-primary)] group-hover/card:text-[var(--accent-violet)]'
                        }`}>
                          {plan.name}
                        </h3>
