          ...
          {MODULES.map(mod => {
            ...
            return (
              <motion.div
                key={mod.name}
                variants={item}
                className="group relative rounded-2xl border bg-[rgba(12,12,34,0.7)] backdrop-blur-sm p-6 hover:-translate-y-1.5 transition-all duration-300 cursor-default overflow-hidden"
                style={{ borderColor: 'rgba(162,130,255,0.1)' }}
                whileHover={{ borderColor: mod.border }}
              >
